...
function resultRowsTable(title, rows, suffix) {
  ...
  const measuredLabels = new Set([0, 1, 2].map(measuredLabel));
...
function chartSvg(series) {
  ...
  return `<svg class="chart" viewBox="0 0 600 250" role="img">
    ...
    <text x="42" y="24" font-size="11" text-anchor="middle" fill="#555">${state.resultType === 0 ? (state.language === "en" ? "sec" : "წმ") : "m² Sab"}</text>
